...
[3] B Ge, M Makkie, J Wang, S Zhao, X Jiang, X Li，<i>Q. Zhao</i>, L Guo, T Liu.（2015）."Signal sampling for efficient sparse representation of resting state fMRI data". pp. 1360-1363.<b>(<i>ISBI, 2015</i>)</b>.

[4] <i>Q. Zhao</i>, WXY Li, X Jiang, J Lv, J Lu, T Liu.(2018)."Functional brain networks reconstruction using group sparsity-regularized learning".12,758-770.(SCI，2区，IF=3.985)
